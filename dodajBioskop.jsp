	...
	<tr><td>
		<table><tr><td  valign="top">
			...
			%>
                       ...
                       <td id="databar" >
                           <h2 style=" margin-top:35px; margin-left:220px;">Dodaj Bioskop</h2>
                    <form action="AdminServlet?action=addBioskop" method="POST" >
                        <table style="margin-left: 40%; width:550px; height:300px;">
                            <tr>
                                
                                <td>Bioskop</td>
                                <td><input type="text" name="bioskop" placeholder="Naziv" required/></td>
                            </tr>
                             <tr>
                                <td>Lokacija:</td>
                                <td><input type="text" name="lokacija" placeholder="Adresa" required/></td>
                            </tr>
                             <tr>
                                <td>Grad:</td>
