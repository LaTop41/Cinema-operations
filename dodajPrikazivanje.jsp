...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Dodaj Prikazivanje</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<tr><td>
		<table><tr><td  valign="top">
			...
			%>
                       ...
                       <td id="databar" >
                           <h2 style=" margin-top:35px; margin-left:220px;">Dodaj Prikazivanje</h2>
                    <form action="AdminServlet?action=addPrikazivanje" method="POST" >
                        <table style="margin-left: 40%; width:550px; height:300px;">
                            <tr>
                                
                                <td>Film:</td>
                                <td><input type="text" name="film" placeholder="Film" required/></td>
                            </tr>
                             <tr>
                                <td>Sala:</td>
                                <td><select name="sala" required>
                             ...
                             <tr>
                                <td>Bioskop:</td>
                                <td><select name="bioskop" required>
                             ...
                             <tr>
                                ...
                                <td><input id="datepicker"  type="text" name="datum"  required /></td>
                            </tr>
                            <tr>
                                <td>Cena:</td>
                            ...
                            <tr>
                                ...
                                <td><input type="reset" name="RESETUJ" /></td>
                            </tr>
                        </table>
                    </form>
                    </td>
