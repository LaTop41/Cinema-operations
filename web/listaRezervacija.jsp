	...
	<tr><td>
		<table><tr><td  valign="top">
			...
			%>
                        ...
                        <td id="databar">
                               <%
                        out.print("<div style='width:620px; height:300px;  margin-top:20px;'>");
                        out.print("<h2>Rezervacije</h2>");
                        out.print("<table border='1'>");
                        out.print("<tr>");
                        out.print("<th>ID:</th>");
                        out.print("<th>Ime:</th>");
                        out.print("<th>Prezime:</th>");
                        out.print("<th>Film:</th>");
                        out.print("<th>Broj sedista:</th>");
                        out.print("<th>Datum:</th>");
                        out.print("<th>Cena:</th>");
                        out.print("</tr>");
                        ArrayList<Narudzbenica> rezervacijaList = (ArrayList<Narudzbenica>) request.getAttribute("rezervacijaList");
                        for (int i = 0; i < rezervacijaList.size(); i++) {
                                out.print("<tr>");
                                out.print("<td>" + rezervacijaList.get(i).getNarudzbenicaId() + "</td>");
                                out.print("<td>" + rezervacijaList.get(i).getIme() + "</td>");
                                out.print("<td>" + rezervacijaList.get(i).getPrezime() + "</td>");
                                out.print("<td>" + rezervacijaList.get(i).getFilm() + "</td>");
                                out.print("<td>" + rezervacijaList.get(i).getSedisteId() + "</td>");
                                 out.print("<td>" + rezervacijaList.get(i).getDatum() + "</td>");
                                out.print("<td>" + rezervacijaList.get(i).getUkupnaCena() +"din"+ "</td>");
