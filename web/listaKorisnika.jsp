	...
	<tr><td>
		<table><tr><td  valign="top">
			...
			%>
                        ...
                        <td id="databar">
                               <%
                        out.print("<div style='width:500px; height:300px; margin-top:20px;'>");
                        out.print("<h2>Korisnici</h2>");
                        ...
                        out.print("<th>Pol:</th>");
                        out.print("</tr>");
                        ArrayList<Korisnik> korisnikList = (ArrayList<Korisnik>) request.getAttribute("korisnikList");
                        for (int i = 0; i < korisnikList.size(); i++) {
                                out.print("<tr>");
                                out.print("<td>" + korisnikList.get(i).getKorisnikId() + "</td>");
                                out.print("<td>" + korisnikList.get(i).getIme() + "</td>");
                                out.print("<td>" + korisnikList.get(i).getPrezime() + "</td>");
                                out.print("<td>" + korisnikList.get(i).getTelefon() + "</td>");
                                 out.print("<td>" + korisnikList.get(i).getEmail() + "</td>");
                                out.print("<td>" + korisnikList.get(i).getPol() + "</td>");
