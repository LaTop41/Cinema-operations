	...
	<tr><td>
		<table><tr><td  valign="top">
			...
			%>
                       ...
                       <td id="databar" >
                            <h2 style=" margin-top:35px; margin-left:220px;">Obriši Korisnika</h2>
                    <form action="ObrisiKorisnikaServlet" method="post" >
                        <table style="margin-left: 40%; width:550px; height:300px;">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td>User Type:</td>
                                <td><input type="radio" name="userType" value="korisnik" />Korisnik
                                <input type="radio" name="userType" value="menadzer" />Menadzer</td>
                            </tr>
                             
                            <tr>
                                <td><input type="submit" name="Registruj se" /></td>
